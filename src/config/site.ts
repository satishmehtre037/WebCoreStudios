...
export const PINNED_PROJECTS_DATA = [
  {
    id: "restaurant-os",
    title: "RestaurantOS Platform",
    category: "Hospitality Operating Engine",
    status: "live" as const,
    description: "An integrated operating engine combining contactless QR ordering, low-latency kitchen dispatch screens, automated table reservations, and real-time sales telemetry.",
    tags: ["React 19", "WebSockets", "Node.js", "Redis", "Tailwind CSS"],
    keyFeatures: [
      "Sub-100ms real-time kitchen order dispatch telemetry",
      "Dynamic contactless QR menu & instant table checkouts",
      "Offline-first POS synchronization for uninterrupted service",
      "Integrated multi-location inventory & table analytics",
    ],
    desktopPreview: null,
    mobilePreview: null,
    overview: "RestaurantOS was built to eliminate costly third-party delivery marketplace commissions while speeding up front-of-house service and kitchen dispatch synchronization.",
    techStack: ["React 19", "TypeScript", "Node.js", "WebSockets", "Redis", "PostgreSQL", "Tailwind CSS"],
    timeline: "8 Weeks (Engineering & Field Deployment)",
    challenges: "Handling network drops during peak restaurant dinner rushes required building an offline-first indexedDB cache with automatic WebSocket retry queues.",
    results: "Reduced average order dispatch time by 65% across 8 live dining venues while saving over $180,000 in annual third-party platform commissions.",
    liveUrl: "https://webcorestudios.com/products/restaurant-os",
    githubUrl: "https://github.com/webcorestudios/restaurant-os",
  },
  {
    id: "cake-os",
    title: "CakeOS E-Commerce",
    category: "Bespoke Confectionery Suite",
    status: "live" as const,
    description: "A specialized e-commerce engine designed for custom bakeries, enabling multi-tier cake configuration, instant WhatsApp checkout flows, and date-locked slot management.",
    tags: ["Next.js App Router", "WhatsApp API", "Framer Motion", "Tailwind CSS"],
    keyFeatures: [
      "Interactive 3D-assisted cake tier & flavor customizer",
      "Automated WhatsApp business order confirmation payload",
      "Capacity-gated calendar booking & pickup slot management",
      "Dynamic photo gallery with customer review integration",
    ],
    desktopPreview: null,
    mobilePreview: null,
    overview: "Bakeries creating artisanal custom products struggle with standard e-commerce platforms like Shopify that lack tier-building configurations and direct WhatsApp purchasing workflows.",
    techStack: ["Next.js 16", "TypeScript", "Tailwind CSS", "Framer Motion", "WhatsApp Business Cloud API"],
    timeline: "5 Weeks (Discovery to Production)",
    challenges: "Translating complex bespoke baking options (flavors, fillings, dietary tags, multi-tier sizes) into a frictionless 3-step mobile checkout UI.",
    results: "340% increase in qualified custom order inquiries within 30 days for flagship partner brand Wake Up Cakes & Ice Cream.",
    liveUrl: "https://webcorestudios.com/products/cake-os",
    githubUrl: "https://github.com/webcorestudios/cake-os",
  },
  {
    id: "proof-os",
    title: "ProofOS Financial Engine",
    category: "SaaS & FinTech Infrastructure",
    tagline: "Automated verification, compliance audit trails, and financial analytics.",
    status: "live" as const,
    description: "Enterprise SaaS platform providing multi-tenant ledger diffing, automated transaction proofing, and real-time compliance reporting dashboards.",
    tags: ["Next.js", "TypeScript", "PostgreSQL", "Prisma", "Tailwind CSS"],
    keyFeatures: [
      "Automated cryptographic ledger verification & reconciliation",
      "Real-time fraud anomaly telemetry & instant webhook alerts",
      "Role-based audit logging with immutable historical diffs",
      "Dark-mode executive reporting dashboards with instant CSV export",
    ],
    desktopPreview: null,
    mobilePreview: null,
    overview: "Financial and audit teams spending dozens of hours verifying multi-bank ledger entries manually needed a zero-trust, automated proofing engine.",
    techStack: ["Next.js 16", "TypeScript", "PostgreSQL", "Prisma", "Tailwind CSS v4", "Chart.js"],
    timeline: "12 Weeks (Core Architecture & Audit Validation)",
    challenges: "Achieving sub-second performance on millions of transaction records while maintaining strict zero-data-loss cryptographic guarantees.",
    results: "Automated 92% of routine accounting ledger diffs, processing over 1.2M transactions with zero compliance audit flags.",
    liveUrl: "https://webcorestudios.com/products/proof-os",
    githubUrl: "https://github.com/webcorestudios/proof-os",
  },
  {
    id: "nexus-ai",
    title: "Nexus AI Knowledge Hub",
    category: "AI Applications & Enterprise RAG",
    status: "live" as const,
    description: "An AI-native knowledge retrieval interface connecting enterprise technical documentation, code repos, and wikis with verified citation links.",
    tags: ["Python", "Vector DB", "React 19", "Streaming Markdown", "Tailwind CSS"],
    keyFeatures: [
      "Domain-specific hybrid vector vector + keyword search pipeline",
      "Sub-800ms streaming LLM response synthesis with inline source references",
      "Enterprise SSO integration with granular document permissions",
      "Interactive code snippet sandbox & architectural diagram renderer",
    ],
    desktopPreview: null,
    mobilePreview: null,
    overview: "Engineering orgs lose hundreds of hours annually searching across siloed documentation and legacy codebases. Nexus AI turns enterprise knowledge into instant, conversational answers.",
    techStack: ["Python", "FastAPI", "Qdrant Vector DB", "React 19", "Tailwind CSS", "GSAP"],
    timeline: "6 Weeks (RAG Pipeline & Custom UI Engine)",
    challenges: "Eliminating model hallucinations while guaranteeing document authorization security at vector retrieval time.",
    results: "Reduced average developer doc search times from 25 minutes down to 8 seconds across a 400-person engineering team.",
    liveUrl: "https://webcorestudios.com/products/nexus-ai",
    githubUrl: "https://github.com/webcorestudios/nexus-ai",
  },
] as const;
