      ...
      <Container>
        ...
        <div ref={listRef} className="flex flex-col border-t border-border/50">
          {SERVICES_DATA.map((service, index) => (
            <div
              key={service.id}
              className="group relative flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-12 py-10 md:py-14 border-b border-border/50 transition-colors duration-500 hover:bg-surface-elevated cursor-none"
            ...
            >
              ...
              <div className="w-full md:w-5/12 pl-6 md:pl-10">
                <span className="text-body-sm text-foreground-secondary mb-2 block font-mono">
              ...
              <div className="w-full md:w-7/12 pl-6 md:pl-0 pr-6 md:pr-10">
